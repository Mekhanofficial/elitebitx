        ...
        >
          ...
          <div className="text-center md:text-left md:left-10 md:w-1/2 relative">
            ...
            <h1 className="text-3xl md:text-5xl text-white font-bold mb-6">
              Next Generation Invest in the future of cryptocurrency with
              EliteBitx
            </h1>
        ...
        <div className="bg-slate-900 flex flex-col md:flex-row items-center justify-center p-8 gap-12 z-50 relative">
          ...
          <div className="max-w-2xl text-center md:text-left">
            ...
            <p className="text-gray-400 mb-4">
              EliteBitx is a leading cryptocurrency investment platform that
              allows anyone to participate in the exciting world of digital
              assets. Our platform is designed to simplify the process of
              investing in cryptocurrency and earning a return on your
              investment.
            </p>
            <p className="text-gray-400 mb-4">
              With low fees and reliable mining operations, EliteBitx ensures
              your investments are secure and profitable. We use
              state-of-the-art facilities and equipment to maximize efficiency,
              and our team of experienced professionals is dedicated to
              delivering the best returns.
            </p>
            <p className="text-gray-400 mb-6">
              Transparency is at the core of what we do. With EliteBitx, you'll
              always know exactly how your investments are performing, thanks to
              our clear and detailed reporting.
            </p>
            <p className="text-gray-400 mb-6">
              EliteBitx Ltd is a registered company in the British Virgin
              Islands (BVI Company Number 2086929). Our registered office is
